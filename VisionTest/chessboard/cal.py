...
for fname in images:
    ...
    criteria = (cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, 235, 0.0001)
...
# 去畸变
img2 = cv2.imread('./IMG_20230128_175300.jpg')
h, w = img2.shape[:2]
...
# images = glob.glob('/home/dingky/chessboard/IMG_20230128_175256.jpg')
# for fname in images:
#     img = cv2.imread(fname)
