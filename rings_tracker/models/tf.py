...
class TFUpsample(keras.layers.Layer):
    def __init__(self, size, scale_factor, mode, w=None):  # warning: all arguments needed including 'w'
        ...
        self.upsample = lambda x: tf.__image.resize(x, (x.shape[1] * 2, x.shape[2] * 2), method=mode)
    ...
    def predict(self, inputs, tf_nms=False, agnostic_nms=False, topk_per_class=100, topk_all=100, iou_thres=0.45,
        ...
        if tf_nms:
            ...
            if agnostic_nms:
                ...
                nms = tf.__image.combined_non_max_suppression(
...
class AgnosticNMS(keras.layers.Layer):
    ...
    def _nms(x, topk_all=100, iou_thres=0.45, conf_thres=0.25):  # agnostic NMS
        ...
        selected_inds = tf.__image.non_max_suppression(
